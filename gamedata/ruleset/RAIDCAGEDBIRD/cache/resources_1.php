...
$gwin = Array(0 => '程序故障', 1 => '全部死亡',2 => '最后幸存',3 => '锁定解除',4 => '无人参加',5 => '核爆全灭',6 => 'GM中止',7=>'幻境解离',8=>'平息笼中鸟');
...
$hidding_typelist = Array(7,14,93);
//不会因躲避禁区、追杀玩家等原因离开地图的NPC（红暮、■、执行官、英灵（没有巫师）、歌神、SCP、种火）
$sentinel_typelist = Array(1,4,7,9,13,20,21,22,26,88,92,93,94);
$typeinfo = Array(
	0=>'参战者',
	1=>'红杀将军',
	2=>'全息幻象',
...
$iteminfo = Array(//注意顺序，AB必须在A的前面，以此类推
	...
	//'R' => '探测仪器',
	'ss' => '歌词卡片',
	// 必须置于通用T类别之前，否则前缀匹配会把RAIDT误判为陷阱。
	// Keep this before generic T so prefix matching does not classify RAID treasures as traps.
	'RAIDT' => 'RAID宝藏',
	'T' => '陷阱',
	'U' => '扫雷设备',
	'V'=> '技能书籍',
...
(
	...
	// RAID专属隐藏地图组 / RAID-only hidden map group
	3 => Array(
		121 => '代码源流',
	),
);
...
$areainfo = Array
	...
	121 => '白色的数据流沿着看不见的河床奔涌。<br>芙蓉留下的转换接口悬浮在源流中央；在这里可以把本轮指定素材转化为封印数据。<br>',
);
...
$dinfo = Array(
	...
	61 => '你只看到笼中鸟的外壳在视野中闪了一下。<br>下一刻，天文数字般的损伤越过了所有防护；你的身体、装备与残骸一并被报应洪流从幻境中抹去。<br>',
	62 => '充能完成的蜂鸣声贯穿整片地图。<br>数据洪流从暴走笼中鸟脚下扩散，玩家、NPC与散落物品在同一瞬间被清空；这里没有能够承受它的掩体。<br>',
	63 => '你提交了本轮已经收纳的战利品，撤离信号随即锁定。<br>白光合拢之前，仍在幻境中厮杀的人影迅速远去——你已带着最终结算积分退出本轮RAID。<br>',
);
