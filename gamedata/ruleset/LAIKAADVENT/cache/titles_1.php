...
if(!defined('IN_GAME')) exit('Access Denied'); 
  ...
  (
    ...
    64 => Array('class' => "tlime", 'title'=>" “猴！”
      - 入场奖励：获得额外的全系熟练度，并自带能让你转危为安的技能书。
      - 获取方式：完成成就「逃避可耻？」的阶段二
    "),
    # 66. 叶子钦定！
    ...
    "),
    # 114. 大只佬
    114 => Array('class' => "tclan", 'title'=>" “无论怎么看，这都是一名标准的受王强者。”
      - 入场奖励：佩戴一个「★闪耀护符★」入场，但它有什么用呢？
      - 获取方式：承受一次一百万以上的伤害。
    "),
  ...
  (
    ...
    64 => Array(
      ...
      'itm6' => '现实逃避论～一转攻势之卷', 'itmk6' => 'VS', 'itme6' => 1,  'itms6' => 1, 'itmsk6' => 'tl_oncemore',
      'itm5' => '现实逃避论～风中残烛之卷', 'itmk5' => 'VS', 'itme5' => 1,  'itms5' => 1, 'itmsk5' => 'tl_2ndchance',
    ),
    # 114. 大只佬
    114 => Array(
